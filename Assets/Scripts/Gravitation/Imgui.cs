...
public class Imgui : MonoBehaviour
{
    ...
    private void OnLayout(UImGui.UImGui obj)
    {
        ImGui.Begin("Config");
                ...
                {
                    ImGui.DragInt("GeneNumber", ref bodyInit.geneNumber, 10f, 1, 10000);
                    ImGui.DragFloat("GeneSpeed", ref bodyInit.geneSpeed, 0.5f, 1f, 20f);
                    ImGui.DragFloat("SimSpeed", ref bodyInit.simSpeed, 0.001f, 0.07f, 30.0f);
                    ImGui.DragFloat("Gravity", ref bodyInit.G, 0.001f, 0.1f, 3f);
                    ImGui.DragFloat("PlanetMaxPos", ref bodyInit.planetMaxPos, 50f, 500f, 5000f);
                    ImGui.DragIntRange2("PlanetGeneMass",ref bodyInit.minMass,ref bodyInit.maxMass,5f,1,500);
                ...
                if(ImGui.CollapsingHeader("More"))
                {
                    ...
                    ImGui.Checkbox("ConservationOfMomentum", ref bodyInit.enableMomentum);
